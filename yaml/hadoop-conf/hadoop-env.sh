...
export YARN_PROXYSERVER_HEAPSIZE=$[2048/2]
export YARN_NODEMANAGER_HEAPSIZE=1024
export HADOOP_JOB_HISTORYSERVER_HEAPSIZE=$[2048/2]
export HADOOP_NAMENODE_HEAPSIZE=1024
export HADOOP_DATANODE_HEAPSIZE=1024
#export HADOOP_SECONDARY_NAMENODE_HEAPSIZE=


if [ "$HADOOP_HEAPSIZE" == "YARN_RESOURCEMANAGER_HEAPSIZE" ]; then
  export HADOOP_HEAPSIZE=$YARN_RESOURCEMANAGER_HEAPSIZE
fi

if [ "$HADOOP_HEAPSIZE" == "YARN_PROXYSERVER_HEAPSIZE" ]; then
  export HADOOP_HEAPSIZE=$YARN_PROXYSERVER_HEAPSIZE
fi

if [ "$HADOOP_HEAPSIZE" == "YARN_NODEMANAGER_HEAPSIZE" ]; then
  export HADOOP_HEAPSIZE=$YARN_NODEMANAGER_HEAPSIZE
fi

if [ "$HADOOP_HEAPSIZE" == "HADOOP_JOB_HISTORYSERVER_HEAPSIZE" ]; then
  export HADOOP_HEAPSIZE=$HADOOP_JOB_HISTORYSERVER_HEAPSIZE
fi
